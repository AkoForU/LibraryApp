...
namespace Login.view
{
    public partial class Register : Form
    {
        ...
        private void e_Click(object sender, EventArgs e)
        {
            ...
            else if (usernamechecker.ForeColor == Color.Red) MessageBox.Show("Username Already Taken");
            else
            {
                string sqlcommand = $"INSERT INTO Users(Username,hashpswd) VALUES('{usernametext.Text}','{_form.QuickHash(passwordtext.Text)}')";
        ...
        public List<string> readusername()
        {
            ...
            string stringsql = $"SELECT Username from Users";
